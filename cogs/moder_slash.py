...
class SlashModerator(commands.Cog):
    ...
    @commands.slash_command(
        ...
        options=[
            Option(
                name='member',
                description='Участник, которого надо кикнуть',
    ...
    async def kick(self, inter, member: Member, reason: str = None):
        ...
        desc_kick = ['Не делай так больше, пожалуйста)', 'Давай в следующий раз без этого..',
                     'В следующий раз будь осторожнее..', 'Давай бкак-нибудь осторожнее(', 'А ты мне нравился((',
    ...
    @commands.slash_command(
        ...
        options=[
            Option(
                name='id',
                description='ID участника, которого надо разбанить',
                type=OptionType.string,
                required=True
            ),
            Option(
    ...
    async def ban(self, inter, member: Member, reason: str = None, time: str = None):
    ...
    @commands.slash_command(
        ...
        options=[
            ...
            Option(
                name='time',
                description='Время, на которое участник будет замучен',
                type=OptionType.string,
                required=True
            ),
            Option(
    ...
    async def mute(self, inter, member: Member, time: str, reason: str = None):
        ...
        after_mute = [f'Участник **{member.mention}** наконец-то был размучен',
                      ...
                      f'Участник **{member.mention}** отдохнул и теперь готов к новым приключениям',
                      f'Участник **{member.mention}** одумался и теперь имеет светлый и ясный ум',
    ...
    @commands.slash_command(
        ...
        options=[
            Option(
                name='member',
                description='Участник, с которого надо снять мут',
                type=OptionType.user,
                required=True
            ),
            Option(
    ...
    @commands.slash_command(
        name='slowmode',
        description='Настройка медленного режима',
        options=[
            Option(
                name='time',
                description='Длительность медленного режима (для отключения медленного режима введите 0)',
                type=OptionType.string,
                required=True
            ),
            Option(
                name='channel',
                description='В каком канале настраиваем медленный режим',
                type=OptionType.channel,
                required=False
            )
        ]
    )
    async def _slow_mode(self, inter, time: str, channel: str = None):
        wrong_time = ['Неверное время!',
                      'Неправильное время',
                      'Такое невозможно',
                      'Введи правильное время',
...
def setup(bot):
    bot.add_cog(SlashModerator(bot))


""",
                      f'<:checkmark:905943731067305996> | Победа!',
                      f'<:checkmark:905943731067305996> | Отлично!',
                      f'<:checkmark:905943731067305996> | Получил!?',
                      f'<:checkmark:905943731067305996> | Наверное так надо...',
                      f'<:checkmark:905943731067305996> | Сам виноват'"""
...
"""title='<:deletesign:905943741775368272> | Ошибка!'"""
"""f'<:checkmark:905943731067305996> | Успешно!'"""

"""kick"""
"""waitkick = ['💬 | Ожидание кика...',
                    '💬 | Ждем кика...',
                    f'💬 | Ждем когда **{member.name}** будет кикнут...',
                    f'💬 | Пью чай, потом кикну **{member.name}**',
                    '💬 | Пью кофэ, давайте как-нибудь сами',
                    '💬 | Летал в облаках, уже спускаюсь чтоб выдать кик',
                    f'💬 | Сейчас кикну **{member.name}**',
                    f'💬 | Снаряжаю **{member.name}** в полет отсюдава',
                    '💬 | Разогреваю кикалку',
                    f'💬 | Жду последнее слово **{member.name}**',
                    f'💬 | Настраиваю траекторию полета для **{member.name}**',
                    '💬 | Готовлю котлетку с пюрешкой',
                    '💬 | Заправляю несквик']

        embed = Embed(
            title=choice(waitkick),
            color=0xc58dfc,
...
"""ban"""
"""waitban = ['💬 | Ожидание бана...',
                       '💬 | Ждем бана...',
                       f'💬 | Ждем когда {member.name} будет забанен...',
                       f'💬 | Пью чай, потом кикну {member.name}',
                       '💬 | Пью кофэ, давайте как-нибудь сами',
                       '💬 | Летал в облаках, уже спускаюсь чтоб выдать кик',
                       f'💬 | Сейчас забаню {member.name}',
                       f'💬 | Снаряжаю {member.name} в полет отсюдава',
                       '💬 | Разогреваю кикалку',
                       f'💬 | Жду последнее слово {member.name}',
                       f'💬 | Настраиваю траекторию полета для {member.name}',
