...
class HelpSlash(commands.Cog):
    ...
    @commands.slash_command(
        name='help',
        description='Получить информацию о всех командах бота',
        options=[]
    )
    async def _help(self, inter):
        ...
        fun_embed = disnake.Embed(
            ...
            description='**echo** - повтор твоего сообщения [сообщение]'
                        ...
                        '\n**coin** - случайный выбор "Орёл | Решка"',
            color=0x8cc63f)
        ...
        #          embed4, embed5, embed6,
        #          embed7, embed8, embed9, embed10]
...
"""embed.add_field(name='🎶 **Музыка:** ',
                        value='**play** - поиск и воспроизведение музыки [название/ссылка на ютуб]'
                              '\n**pause** - пауза'
                              '\n**resume** - продолжение'
                              '\n**skip** - пропуск данного трека'
                              '\n**queue** - список треков в очереди'
                              '\n**join** - **eva** присоединится к вашему голосовому каналу'
                              '\n**leave** - **eva** покинет ваш голосовой канал'
                              '\n**now** - песня, играющая сейчас'
                              '\n**save** - **eva** пришлет в лс название играющей сейчас музыки'
                              '\n**stop** - остановка воспроизведения'
                              '\n**loop** - установка трека на повтор'
